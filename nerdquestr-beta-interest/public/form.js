...
(() => {
  ...
  const ready = /^https:\/\/formspree\.io\/f\/[a-zA-Z0-9]{6,64}\/?$/.test(endpoint) && config.launchApproved === true;
  ...
  form.addEventListener("submit", (event) => {
    ...
    // Normal HTTPS POST. Formspree, not this page, determines acceptance, CAPTCHA,
    // errors and confirmation. Do not disable successful controls before posting.
